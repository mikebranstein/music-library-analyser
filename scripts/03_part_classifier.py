...
DEFAULT_LEXICON: dict[str, Any] = {
    ...
    "instruments": {
        ...
        "soprano_sax": ["soprano saxophone", "soprano saxes", "soprano sax", "sax soprano", "sop sax"],
        "alto_sax": ["alto saxophone", "alto saxes", "alto sax", "sax alto", "eb alto sax", "e flat alto saxophone", "alto"],
        "tenor_sax": ["tenor saxophone", "tenor saxes", "tenor sax", "sax tenor", "bb tenor sax"],
        "baritone_sax": [
            "baritone saxophone", "baritone saxes", "baritone sax", "sax baritone",
            "bari saxes", "bari sax", "eb baritone saxophone",
        ],
        "bass_sax": ["bass saxophone", "bass saxes", "bass sax"],
        "soprano_cornet": ["soprano cornet", "eb soprano cornet", "sop cornet", "eb cornet", "piston in es", "piston in eb", "eb piston", "piston eb"],
        "cornet": ["solo cornet", "repiano cornet", "ripieno cornet", "bb cornet", "cornet", "cornets", "piston", "pistons"],
        "trumpet": ["bb trumpet", "b flat trumpet", "trumpet", "trumpets", "tpt", "tpts"],
        "flugelhorn": ["flugelhorn", "flugelhorns", "flugel horn", "flugel", "fluegelhorn", "fluglehorn", "fluglehorns"],
        "horn": ["horn in f", "f horn", "french horn", "horn", "horns", "hn"],
        "tenor_horn": ["tenor horn", "tenorhorn", "eb tenor horn", "eb horn", "alto horn"],
        "trombone": ["tenor trombone", "trombone", "trombones", "posaune", "posaunen", "tbn", "tbns", "tbne"],
        "bass_trombone": ["bass trombone", "bass tbn"],
        "baritone_horn": ["baritone horn", "baritone", "baritones", "bari horn"],
        "euphonium": ["euphonium", "euphoniums", "euph", "eupho"],
        "tuba": [
            "tuba", "tubas", "basses", "bass tuba", "eb bass", "bb bass",
            "bbb", "sousaphone", "contrabass tuba",
        ],
        "string_bass": [
            "string bass", "bass string", "double bass", "contrabass", "acoustic bass", "upright bass",
        ],
    ...
    "sections": {
        ...
        "low_brass": ["trombone", "bass_trombone", "baritone_horn", "euphonium", "tuba"],
